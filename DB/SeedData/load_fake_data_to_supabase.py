...
BOOLEAN_COLUMNS = {"is_primary_contact", "attendance_flag"}
NUMERIC_COLUMNS = {"confidence_score"}
NULLABLE_EMPTY_COLUMNS = {"completed_at", "notes", "parent_feedback", "relation_type"}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Load generated fake CSV data into Supabase.")
